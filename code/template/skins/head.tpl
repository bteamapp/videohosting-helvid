			...
			<ul class="sub-menu">
			    ...
			    <li class="nav-item" id="vall">
    				<a href="javascript:;" class="nav-link nav-toggle">
        				...
        				<span class="title">影视广场</span>
        				<span class="arrow"></span>
    				</a>
    				<ul class="sub-menu" id="vodlist">
                    <?php 
                    foreach($class as $row){
                        echo '<li class="nav-item" id="vlist_'.$row->id.'"><a href="'.links('vod','square','pic',$row->id).'" class="nav-link"> <span class="title">'.$row->name.'</span></a></li>';
                    }
                    ?>
    				</ul>
				</li>
