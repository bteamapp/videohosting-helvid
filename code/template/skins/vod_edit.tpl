<div class="page-content-wrapper">
 ...
 <style type="text/css">.layui-form-radio{padding-right: 0px;}</style>
    ...
    <div class="form-group">
         ...
         <div class="col-md-6">
           <input readonly="readonly" class="form-control" name="panshare" id="panshare" required  lay-required="" placeholder="" value="http://<?=Web_Url.links('play','index',$vod->vid)?>" type="" />
         </div>
    </div>
    <div class="form-group">
