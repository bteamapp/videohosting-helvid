...
<html>
	...
	<form class="layui-form" action="<?=site_url('link/save/'.$id)?>" method="post">
        <table class="layui-table">
            ...
            <tbody>
                <tr><td align="center">标题</td><td><input type="text" name="name" placeholder="请输入标题" value="<?=$name?>" class="layui-input"></td></tr>
                <tr><td align="center">地址</td><td><input type="text" name="url" placeholder="请输入地址" value="<?=$url?>" class="layui-input"></td></tr>
