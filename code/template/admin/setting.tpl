	...
	<body class="setting">
		...
		<div class="layui-tab layui-tab-brief" lay-filter="setting">
			<ul class="layui-tab-title">
				...
				<li class="" lay-id="set6">同步设置</li>
				<li class="" lay-id="set7">其他设置</li>
			</ul>
			<div class="layui-tab-content">
			    ...
			    <div class="layui-tab-item">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="text" name="Zm_Kbps" placeholder="请输如切片后的尺寸" autocomplete="off" class="layui-input" value="<?=Zm_Kbps?>">
						</div>
			    ...
			    <div class="layui-tab-item">
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
      						<input type="radio" name="Tb_Zt" value="0" title="关闭" <?=Tb_Zt==0?'checked':''?>>
							<input type="radio" name="Tb_Zt" value="1" title="开启" <?=Tb_Zt==1?'checked':''?>>
						</div>
						<div class="layui-form-mid layui-word-aux">转码同步开关</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">同步地址</label>
						<div class="layui-input-inline">
							<input type="text" name="Tb_Url" placeholder="请输入同步地址" autocomplete="off" class="layui-input" value="<?=Tb_Url?>">
						</div>
						<div class="layui-form-mid layui-word-aux">如：http://www.xxx.com/api.php</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">同步秘钥</label>
						<div class="layui-input-inline">
							<input type="text" name="Tb_Key" placeholder="请输入同步秘钥" autocomplete="off" class="layui-input" value="<?=Tb_Key?>">
						</div>
						<div class="layui-form-mid layui-word-aux">请输入同步秘钥</div>
					</div>
			    </div>
				<!-- 其他设置 -->
				<div class="layui-tab-item layui-show">
