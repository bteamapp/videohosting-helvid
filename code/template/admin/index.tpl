...
<html>
	<head>
		...
		<style>
			.toggle {position: absolute;float: left;padding-right: 0px;cursor:pointer;margin-right: 0px;color:white;text-align:center;width:25px;height:25px;background-color:#f5a209;line-height:25px;top: 20px;left: 158px;}
			.toggle:hover {background-color:#d3522c;}
		</style>
	</head>
	<body>
		<header>
			...
			<ul class="layui-nav layui-nav-tree">
			    ...
			    <li class="layui-nav-item layui-nav-itemed"> <a href="javascript:;">系统管理</a>
			        <dl class="layui-nav-child">
			            ...
			            <dd><a href="javascript:;" onclick="turnLink(this)" _href="<?=links('server')?>">服务器管理</a></dd>
			            <dd><a href="javascript:;" onclick="turnLink(this)" _href="<?=links('link')?>">友情链接</a></dd>
