...
class Setting extends CI_Controller {
	...
	public function save(){
		...
		if($Zm_Kbps == 0) getjson('切片码率格式不正确');
        ...
        $strs .= "define('Zm_Kbps','".$Zm_Kbps."k');  //切片码率\r\n";
        ...
        $strs .= "define('Tb_Zt',".$Tb_Zt."); //同步状态\r\n";
        $strs .= "define('Tb_Url','".$Tb_Url."'); //同步地址\r\n";
        $strs .= "define('Tb_Key','".$Tb_Key."'); //同步秘钥";
